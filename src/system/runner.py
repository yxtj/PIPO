...
from src.system import util, Server, Client

try:  # Pyfhel is optional; only needed by the client when use_he is enabled
...
def run_client(host: str, port: int, model: torch.nn.Module, inshape: tuple, he,
